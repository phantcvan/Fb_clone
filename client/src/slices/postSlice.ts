...
export const { setPost, setCreatedPost, setContent, setAudience, setBgUrl, setFeeling, setLocation,
  setMediaUrl, setType, setTag, setActionPost, setEditPostId } = postSlice.actions;
