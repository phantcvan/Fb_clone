...
import { getAudience, setAudience } from "../slices/postSlice";
...
const SelectAudience = ({ setSelectAddOn, setUploadPost }: SelectAudienceProps) => {
          ...
          fixed rounded-md z-[80]'>
            ...
            <div className="flex justify-end gap-3 font-semibold mb-3 px-3">
                ...
                <button className="bg-blue-400 text-white px-7 py-2 rounded-md"
                    onClick={() => { setSelectAddOn(0); dispatch(setAudience(newAudience)) }}>
                    Done
                </button>
            </div>
        </div >
