...
interface ReactionProps {
  setUserNowReaction: React.Dispatch<React.SetStateAction<string>>;
  setUserNowReactionImg: React.Dispatch<React.SetStateAction<string>>
  postId: number;
  userNowReaction: string;
  setReactions: React.Dispatch<React.SetStateAction<[] | ReactionType[]>>
}
const Reaction = ({ setUserNowReaction, setUserNowReactionImg, postId, userNowReaction, setReactions }: ReactionProps) => {
  const userNow = useSelector(getUser);
  console.log(userNowReaction);
