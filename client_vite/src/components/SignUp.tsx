                    ...
                    >
                        <div className="flex w-full gap-2 mt-2 mb-1">
                            <div className="bg-fb-gray-light basis-1/2 rounded-md">
                                <input type="text"
                                    className="bg-fb-gray-light pl-1 py-2 w-full border border-fb-gray-dark outline-none rounded-md"
                        ...
                        <div className="flex w-full gap-2 mt-1 mb-2">
                            <select name="date" id="" value={dayInput} onChange={handleChangeDay}
                                className="flex basis-1/3 outline-none bg-fb-gray-light py-2 border border-fb-gray-dark rounded-md">
                                {dayOptions}
                            </select>
                        ...
                        <div className="flex w-full gap-2 mt-1 mb-1">
                            <div className='flex basis-1/3 justify-between gap-2 items-center bg-fb-gray-light border border-fb-gray-dark rounded-md px-3 py-2 '>
